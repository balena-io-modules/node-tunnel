...
* Change the build output folder to "build" [Thodoris Greasidis]
* Reduce the published files [Thodoris Greasidis]

## 4.0.6 - 2025-04-10

* Fix signature for `connect` to enable downstream extension [Pagan Gazzard]

## 4.0.5 - 2025-04-10

* Fix main/types entry points [Pagan Gazzard]
